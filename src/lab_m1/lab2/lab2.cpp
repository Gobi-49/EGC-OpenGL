...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),//turcuaz 0
            // TODO(student): Complete the vertices data for the cube mesh]]
            VertexFormat(glm::vec3(-1,-1,-1), glm::vec3(1,0,0),glm::vec3(0.2, 0.8, 0.6)),//red 1
            VertexFormat(glm::vec3(0,-1,0), glm::vec3(0,0,1),glm::vec3(0.2, 0.8, 0.6)),//blue 2
            VertexFormat(glm::vec3(-0.4,1,0), glm::vec3(0,1,0),glm::vec3(0.2, 0.8, 0.6))//green 3
        };
    ...
    {
        vector<VertexFormat> verticesCerc
        {
        ...
        vector<unsigned int> indicesCerc =
        {
            0,1,2

        };
        meshes["cerc"] = new Mesh("gen Cerc");
        meshes["cerc"]->InitFromData(verticesCerc,indicesCerc);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cerc"], shaders["VertexColor"], glm::vec3(2,2,2), glm::vec3(0.25f));
